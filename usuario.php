          ...
          <div class="contact-info">
            ...
            <form action="usuario.php" method="POST">
              <div class="form-group">
                <label>Nombres:</label>
                <input required type="text" class="form-control br-radius-zero" disabled value="<?php echo $user['Nombres']; ?>"/><br>
                <label>Apellidos:</label>
                <input required type="text" class="form-control br-radius-zero" disabled value="<?php echo $user['Apellidos']; ?>"/>
              </div>
              <div class="form-group">
